---
title: "Skincare mega menu"
date: 2026-09-09
status: implemented
branch: codex/menu-footer-skincare-menu
...
Five skincare cards, category links and skincare bundle promotion.
...
Source: the supplied local export, exported July 14, 2026. Exact decoded node references: `6057:1672`, `6057:1676`, `12342:1795`, `6073:2162`, `6073:2490`.

1920 x 414 panel with 1300px outer rail and 250px promo.
...
| --- | --- | --- | --- |
| `6057:1672` | Skincare | 1920.000 x 1080.000 | Desktop full mockup |
| `6057:1676` | Frame 103 | 1920.000 x 414.000 | Desktop menu panel |
| `12342:1795` | Skincare | 1920.000 x 1080.000 | Desktop full mockup |
| `12342:1799` | Frame 103 | 1920.000 x 414.000 | Desktop menu panel |
...
- Skincare collection and up to five selected products; dynamic Shop All title/count.
...
- The base Skincare artwork includes a Bestselling Makeup label. Record this inconsistency and use an intentional skincare heading.
...
Implemented skincare navigation using selected products or the native collection, live counts, optional prices, and a five-card desktop rail with an editable 250 × 350px promotion. Mobile cards use 100px images with 16px text gaps. Empty collections do not create duplicate products.
