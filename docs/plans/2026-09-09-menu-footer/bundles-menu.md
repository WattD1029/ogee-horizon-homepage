---
title: "Bundles mega menu"
date: 2026-09-09
status: implemented
branch: codex/menu-footer-bundles-menu
...
Six featured bundles and bundle taxonomy in the shorter panel without a forced promo rail.
...
Source: the supplied local export, exported July 14, 2026. Exact decoded node references: `6057:1607`, `6057:1611`, `6073:2371`, `6073:2718`.

1920 x 327 base panel.
...
| --- | --- | --- | --- |
| `6057:1607` | Bundles | 1920.000 x 1080.000 | Desktop full mockup |
| `6057:1611` | Frame 103 | 1920.000 x 327.000 | Desktop menu panel |
...
- Bundles collection and up to six products, preserving merchant order and live availability.
...
- This is navigation to existing products; no new bundle app, discount or cart-composition logic is required.
