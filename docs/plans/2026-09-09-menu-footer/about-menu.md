...
date: 2026-09-09
status: implemented
branch: codex/menu-footer-about-menu
...
Editorial tiles for Our Story, Press, Ingredients and Blog, with the mobile link list.
...
Source: the supplied local export, exported July 14, 2026. Exact decoded node references: `12644:2259`, `12644:3099`, `12644:3174`, `12644:3246`, `12644:3322`, `12644:3326`, `12644:2673`, `12644:3061`.

12644:3326 candidate: 1920 x 319 panel, 1300px rail, four 319px containers and 255px image-menu instances.
...
| --- | --- | --- | --- |
| `12644:2259` | About | 1920.000 x 1080.000 | Desktop full mockup |
| `12644:2263` | Frame 103 | 1920.000 x 319.000 | Desktop menu panel |
| `12644:3099` | About | 1920.000 x 1080.000 | Desktop full mockup |
| `12644:3103` | Frame 103 | 1920.000 x 319.000 | Desktop menu panel |
| `12644:3174` | About | 1920.000 x 1080.000 | Desktop full mockup |
| `12644:3178` | Frame 103 | 1920.000 x 319.000 | Desktop menu panel |
| `12644:3246` | About | 1920.000 x 1080.000 | Desktop full mockup |
| `12644:3250` | Frame 103 | 1920.000 x 319.000 | Desktop menu panel |
| `12644:3322` | About | 1920.000 x 1080.000 | Desktop full mockup |
| `12644:3326` | Frame 103 | 1920.000 x 319.000 | Desktop menu panel |
...
| `12644:3061` | image menu tab | 444.000 x 295.000 | Component-set canvas; not tile dimensions |
...
- About link_list plus up to four optional image_picker/title overrides mapped to configured page/blog destinations.
...
- Five About alternatives and hover yes/no components exist. 12644:3322 is a comparison candidate, not a declared approved design.
...
Implemented four editorial tiles with keyboard-equivalent hover treatment and a simple mobile link list. Native menu destinations override individual editor URLs. Missing destinations render readable text without fake links. The source uses checker placeholders for the first three hover images; these remain merchant image settings. Original Blog artwork is included.
